...
max_time_diff = {"280": 0, "290": 0, "300": 0}
...
DYNAMIC_TAG = ["e28068940000500386620d4f"]
...
for tag in DYNAMIC_TAG: # iterate over the dynamic tags
    ...
    while dist <= 10.0:
        ...
        for index, pwr in enumerate([280, 290, 300]):
    ...
    # for i in range(len(tag_ar)-1):
    #     plt.plot(dist_ar, plot_dict["activ_dif"][0][i], label = f'...{tag_ar[i][-5:]}')
    ...
    def train_models(x_train, x_test, y_train, y_test):
        ...
        # pickle.dump(model3, open("models/knn.sav", 'wb')) # save model
        ...
        # pickle.dump(model1, open("models/rf.sav", 'wb')) # save model
        ...
        # pickle.dump(model2, open("models/dt.sav", 'wb')) # save model
        ...
        # pickle.dump(model4, open("models/gbr.sav", 'wb')) # save model
        ...
        # pickle.dump(model5, open("models/svr.sav", 'wb')) # save model
    ...
    feature_ar = []
    for pwr in [280, 290, 300]:
        feature_ar.append(str(pwr))
        feature_ar.append(f'avg_time_dif_{pwr}')


    # # Cálculo da melhor combinação de 2 tags de referência
    # min_error = 999
    # min_error_pwr = ""
    # for i in range(len(tag_ar)-3):
    #     i2 = i + 1
    #     while i2 <= len(tag_ar)-2:
    #         # feature_ar_copy = feature_ar.copy()
    #         print(f'\nactiv_dif_{i} - activ_dif_{i2}')
    #         ftr_ar = []
    #         for pwr in [280, 290, 300]: 
    #             ftr_ar.append(f'activ_dif_{i}_{pwr}')
    #             ftr_ar.append(f'activ_dif_{i2}_{pwr}')
    #         print(ftr_ar)
    #         error = train_models(x_train[ftr_ar], x_test[ftr_ar], y_train, y_test)
    #         print(error)
    #         if error < min_error:
    #             min_error = error
    #             min_error_pwr = f'activ_dif_{i}_{pwr} - activ_dif_{i2}_{pwr}'
    #         i2 += 1
    # print(min_error_pwr)
    # print(min_error)


    # # Cálculo da melhor combinação de 3 tags de referência
    # min_error = 999
    # min_error_pwr = ""
    # for i in range(len(tag_ar)-4):
    #     i2 = i + 1
    #     while i2 <= len(tag_ar)-3:
    #         i3 = i2 + 1
    #         while i3 <= len(tag_ar)-2:
    #             # feature_ar_copy = feature_ar.copy()
    #             print(f'\nactiv_dif_{i} - activ_dif_{i2} - activ_dif_{i3}')
    #             ftr_ar = []
    #             for pwr in [280, 290, 300]: 
    #                 ftr_ar.append(f'activ_dif_{i}_{pwr}')
    #                 ftr_ar.append(f'activ_dif_{i2}_{pwr}')
    #                 ftr_ar.append(f'activ_dif_{i3}_{pwr}')
    #             print(ftr_ar)
    #             error = train_models(x_train[ftr_ar], x_test[ftr_ar], y_train, y_test)
    #             print(error)
    #             if error < min_error:
    #                 min_error = error
    #                 min_error_pwr = f'activ_dif_{i}_{pwr} - activ_dif_{i2}_{pwr} - activ_dif_{i3}_{pwr}'
    #             i3 += 1
    #         i2 += 1
    # print(min_error_pwr)
    # print(min_error)

    # # Cálculo da melhor combinação de 4 tags de referência
    # min_error = 999
    # min_error_pwr = ""
    # for i in range(len(tag_ar)-5):
    #     i2 = i + 1
    #     while i2 <= len(tag_ar)-4:
    #         i3 = i2 + 1
    #         while i3 <= len(tag_ar)-3:
    #             i4 = i3 + 1
    #             while i4 <= len(tag_ar)-2:
    #                 # feature_ar_copy = feature_ar.copy()
    #                 print(f'\nactiv_dif_{i} - activ_dif_{i2} - activ_dif_{i3} - activ_dif_{i4}')
    #                 ftr_ar = []
    #                 for pwr in [280, 290, 300]: 
    #                     ftr_ar.append(f'activ_dif_{i}_{pwr}')
    #                     ftr_ar.append(f'activ_dif_{i2}_{pwr}')
    #                     ftr_ar.append(f'activ_dif_{i3}_{pwr}')
    #                     ftr_ar.append(f'activ_dif_{i4}_{pwr}')
    #                 print(ftr_ar)
    #                 error = train_models(x_train[ftr_ar], x_test[ftr_ar], y_train, y_test)
    #                 print(error)
    #                 if error < min_error:
    #                     min_error = error
    #                     min_error_pwr = f'activ_dif_{i}_{pwr} - activ_dif_{i2}_{pwr} - activ_dif_{i3}_{pwr} - activ_dif_{i4}_{pwr}'
    #                 i4 += 1
    #             i3 += 1
    #         i2 += 1
    # print(min_error_pwr)
    ...
    # # Cálculo da melhor combinação de 5 tags de referência
    # min_error = 999
    # min_error_pwr = ""
    # for i in range(len(tag_ar)-6):
    #     i2 = i + 1
    #     while i2 <= len(tag_ar)-5:
    #         i3 = i2 + 1
    #         while i3 <= len(tag_ar)-4:
    #             i4 = i3 + 1
    #             while i4 <= len(tag_ar)-3:
    #                 i5 = i4 + 1
    #                 while i5 <= len(tag_ar)-2:
    #                     # feature_ar_copy = feature_ar.copy()
    #                     print(f'\nactiv_dif_{i} - activ_dif_{i2} - activ_dif_{i3} - activ_dif_{i4} - activ_dif_{i5}')
    #                     ftr_ar = []
    #                     for pwr in [280, 290, 300]: 
    #                         ftr_ar.append(f'activ_dif_{i}_{pwr}')
    #                         ftr_ar.append(f'activ_dif_{i2}_{pwr}')
    #                         ftr_ar.append(f'activ_dif_{i3}_{pwr}')
    #                         ftr_ar.append(f'activ_dif_{i4}_{pwr}')
    #                         ftr_ar.append(f'activ_dif_{i5}_{pwr}')
    #                     # print(ftr_ar)
    #                     error = train_models(x_train[ftr_ar], x_test[ftr_ar], y_train, y_test)
    #                     print(error)
    #                     if error < min_error:
    #                         min_error = error
    #                         min_error_pwr = f'activ_dif_{i}_{pwr} - activ_dif_{i2}_{pwr} - activ_dif_{i3}_{pwr} - activ_dif_{i4}_{pwr} - activ_dif_{i5}_{pwr}'
    #                     i5 += 1
    #                 i4 += 1
    #             i3 += 1
    #         i2 += 1
    ...
    # # Cálculo da melhor combinação de 6 tags de referência
    # min_error = 999
    # min_error_pwr = ""
    # for i in range(len(tag_ar)-7):
    #     i2 = i + 1
    #     while i2 <= len(tag_ar)-6:
    #         i3 = i2 + 1
    #         while i3 <= len(tag_ar)-5:
    #             i4 = i3 + 1
    #             while i4 <= len(tag_ar)-4:
    #                 i5 = i4 + 1
    #                 while i5 <= len(tag_ar)-3:
    #                     i6 = i5 + 1
    #                     while i6 <= len(tag_ar)-2:
    #                         # feature_ar_copy = feature_ar.copy()
    #                         print(f'\nactiv_dif_{i} - activ_dif_{i2} - activ_dif_{i3} - activ_dif_{i4} - activ_dif_{i5} - activ_dif_{i6}')
    #                         ftr_ar = []
    #                         for pwr in [280, 290, 300]: 
    #                             ftr_ar.append(f'activ_dif_{i}_{pwr}')
    #                             ftr_ar.append(f'activ_dif_{i2}_{pwr}')
    ...
    #                             ftr_ar.append(f'activ_dif_{i4}_{pwr}')
    #                             ftr_ar.append(f'activ_dif_{i5}_{pwr}')
    #                             ftr_ar.append(f'activ_dif_{i6}_{pwr}')
    #                         # print(ftr_ar)
    #                         error = train_models(x_train[ftr_ar], x_test[ftr_ar], y_train, y_test)
    #                         print(error)
    #                         if error < min_error:
    #                             min_error = error
    #                             min_error_pwr = f'activ_dif_{i}_{pwr} - activ_dif_{i2}_{pwr} - activ_dif_{i3}_{pwr} - activ_dif_{i4}_{pwr} - activ_dif_{i5}_{pwr} - activ_dif_{i6}_{pwr}'
    #                         i6 += 1
    #                     i5 += 1
    #                 i4 += 1
    #             i3 += 1
