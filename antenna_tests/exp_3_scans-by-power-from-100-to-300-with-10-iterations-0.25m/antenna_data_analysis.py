...
# Power selection
# x_train = train_df[["200", "280", "290", "300"]]
# x_test = test_df[["200", "280", "290", "300"]]
# x_train = train_df[["200", "280", "290", "300", "avg_time_dif_200", "avg_time_dif_280", "avg_time_dif_290", "avg_time_dif_300"]]
# x_test = test_df[["200", "280", "290", "300", "avg_time_dif_200", "avg_time_dif_280", "avg_time_dif_290", "avg_time_dif_300"]]
...
# k_best = SelectKBest(mutual_info_regression, k=4)
# x_train_3 = pd.DataFrame(k_best.fit_transform(x_train, y_train.values.ravel()))
# x_test_3 = pd.DataFrame(k_best.transform(x_test))
# # print(x_train)
